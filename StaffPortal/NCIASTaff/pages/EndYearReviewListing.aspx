<%@ Page Title="End Year Review" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="EndYearReviewListing.aspx.cs" Inherits="NCIASTaff.pages.EndYearReviewListing" %>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-server"></i>&nbsp;End Year Review</h3>
