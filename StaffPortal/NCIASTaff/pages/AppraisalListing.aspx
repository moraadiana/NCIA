<%@ Page Title="Appraisal Listing" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="AppraisalListing.aspx.cs" Inherits="NCIASTaff.AppraisalListing" %>
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-server"></i>&nbsp;My Appraisals</h3>
