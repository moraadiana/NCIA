<%@ Page Title="Petty Cash Lines (Reimbursement)" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="PettyCashLines(Reimbursement).aspx.cs" Inherits="NCIASTaff.pages.PettyCashLines_Reimbursement_" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main1" runat="server">
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Petty Cash Reimbursement</h1>
            <ol class="breadcrumb">
                <li><a href="Dashboard.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li class="active">Petty Cash Reimbursement</li>
            </ol>
        </section>
                        ...
                        <asp:View ID="vwHeader" runat="server">
                            <div class="box box-info box-solid">
                                <div class="box-header with-border">
                                    <h3 class="box-title">New Petty Cash Reimbursement</h3>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Petty Cash Doc.</label>
                                                    <asp:DropDownList ID="ddlPostedPettyCash" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="box box-info box-solid">
                                        <div class="box-header">
                                            <h3 class="box-title">Petty Cash Lines (Reimbursement) &mdash;
                                        <asp:Label ID="lblPettyCashReNo" runat="server" Text=""></asp:Label></h3>
                                        </div>
                                        <div class="box-body">
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlVote" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                            ...
                                            <h4>Petty Cash Lines (Reimbursment)</h4>
                                            <asp:GridView ID="gvLines" AutoGenerateColumns="false" DataKeyNames="Vote" class="table table-responsive no-padding table-bordered table-hover" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" SortExpression="" HeaderStyle-HorizontalAlign="Left">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnRemove" CssClass="label label-danger" runat="server" ToolTip="Click to Remove line" OnClick="lbtnRemove_Click" OnClientClick="return confirm('Are you sure you want to delete this line?')" CommandArgument='<%# Eval("Vote")%>'><i class="fa fa-remove"></i> Remove</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            ...
                                            <table class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <a href="PettyCashListing(Reimbursement).aspx" class="btn btn-warning pull-left"><i class="fa fa-backward"></i>&nbsp;Back</a>
                                                        </th>
                                                        <th></th>
                                                        <th></th>
                                                        <th></th>
